...
path = '/home/willytell/Documentos/PhD/ioth'
excel_features = os.path.join(path, 'features.xlsx')
proportion = 0.7  # define the training samples proportion
...
# applying selection of features (it removes any column that is not included in the 'selection' list)
